...
import 'package:slicing_ui_flutter/models/doctor_model.dart';
import 'package:slicing_ui_flutter/models/service_model.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  ListView _doctors() {
    return ListView.separated(
        ...
        shrinkWrap: true,
        itemBuilder: (context, index) => _doctorContent(doctors[index]),
  ...
  Container _doctorContent(DoctorModel doctorModel) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(boxShadow: [
        BoxShadow(
            color: const Color(0xFF35485A).withOpacity(.12),
            blurRadius: 30,
  ...
  Widget _search() {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Color(0xFFF6F6F6), borderRadius: BorderRadius.circular(14)),
      child: TextFormField(
        decoration: InputDecoration(
            border: InputBorder.none,
            prefixIcon: Icon(FeatherIcons.search, color: Color(0xFFADACAD)),
